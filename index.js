...
export default function Home() {
  ...
  const onSubmit = (event) => {
    ...
    sendMessage("сформувати ситуаційну головоломку (загадку яку можна розгадати ставлячи питання на які можна відповісти лише так або ні) важкої складності з відповіддю яка б була повністю логічна в теперешній час. Текст має читатись легко і бути високої якості. Надайте вихідні дані у форматі: \nСитуація: {ситуація з нового рядка} \nВідповідь: {відповідь}");
    setMessage("");
  };
  ...
  return (
    <div>
      ...
      <h1 className={styles.heading1}>Yes/No Game</h1>
